  ...
  const handleConcluir = async () => {
    ...
    try {
      ...
      if (service) {
        ...
        const isCoverLetterStep = service.steps[stepIdx]?.id === "cos_presentation_letter";
        if (!isCoverLetterStep && !isMotionEnd && (isCorrection || (nextStep?.type === "admin_action") || isFinal)) {
