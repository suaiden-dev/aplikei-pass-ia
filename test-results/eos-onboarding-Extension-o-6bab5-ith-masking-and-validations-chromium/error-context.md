...
- heading "Dependentes 1 / 1 slots" [level=3]
- paragraph: Você pagou por 1 dependente(s)
...
- button:
  - img
- text: Nome Completo
- button "Nome Completo":
  - img
- textbox "Como consta no passaporte": Dependente 1
- text: Parentesco
- button "Parentesco":
  - img
- combobox:
  - option "Selecionar..."
  - option "Cônjuge" [selected]
  - option "Filho(a)"
  - option "Outro"
...
- textbox: 1995-05-15
- text: Data Exp. I-94
- button "Data Exp. I-94":
  - img
- textbox: 2026-12-31
- text: Data do Casamento
- button "Data do Casamento":
  - img
- textbox: 2020-01-10
- img
- paragraph: Aviso de Elegibilidade Se o casamento aconteceu depois que o dependente fez 18 anos, ele pode não ser elegível, caso não seja filho do aplicante principal.
- button "Voltar":
  - img
  - text: Voltar
