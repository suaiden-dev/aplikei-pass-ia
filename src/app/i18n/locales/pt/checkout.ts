    ...
    product: {
        ...
        paymentMethods: {
            ...
            parcelow: {
                ...
                sublabel: "BRL",
                notice: "Pague em até **12x fixas**. Valor convertido para Real com taxas de parcelamento. Câmbio garantido.",
                cpfLabel: "CPF do Titular do Cartão",
                cpfPlaceholder: "000.000.000-00",
                cpfRequired: "Informe um CPF válido para prosseguir com o parcelamento.",
                cpfNotice: "Necessário para emissão da nota fiscal."
            },
            zelle: {
                label: "Zelle",
                sublabel: "USD",
