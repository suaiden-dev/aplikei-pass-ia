const dashboard = {
  dashboard: {
    ...
    passportUploadModal: {
      ...
      description: "Hold your open passport next to your face",
      closeTitle: "Close and go back",
      reqHoldingPassport: "Holding Passport",
      reqLegibleData: "Legible Data",
      reqWhiteBackground: "White Background",
      reqNoGlasses: "No Glasses",
      reqVisibleFaceId: "Face and ID Visible",
      reqGoodLighting: "Good Lighting",
      uploadPhoto: "Upload Photo",
      changePhoto: "Change Photo",
      supportedFormats: "Supported formats: JPG, PNG. Max 5MB.",
      confirmAndProceed: "Confirm and Proceed",
      sending: "Uploading...",
      errorMaxSize: "The photo must be a maximum of 5MB.",
      successUpload: "Photo uploaded successfully!",
      errorUpload: "Error uploading photo: {error}"
    },
    activeProcesses: "Your Active Cases",
    selectProcess: "Select Case",
    getProcesses: "Get Cases",
    ...
    status: {
      ...
      deniedEncerrado: "Denied / Closed",
      awaitingRfe: "Awaiting RFE",
      inProgress: "In Progress",
    },
    badges: {
      approved: "Approved",
      ...
      finished: "Finished",
      active: "Active",
      awaitingRfe: "RFE Pending",
      soldOut: "Sold Out",
      available: "Available",
    },
    sections: {
      activeCases: "Your Active Cases",
      activeCasesDesc: "Track the progress and next steps of your guides.",
      getCases: "Get Cases",
      getCasesDesc: "Enhance your journey with specialized guides.",
      noActiveCases: "No active cases yet.",
      noActiveCasesDesc: "Get started with one of our guides below.",
    },
    serviceCard: {
      ...
      startNow: "Start Now",
      finishCurrentFirst: "Complete your current process first",
    },
    myProcesses: "My Cases",
    trackStatus: "Track the status of all your guides and applications.",
    noActiveProcesses: "You don't have any active cases yet.",
    progress: "Progress",
    accessDetails: "ACCESS DETAILS",
    myCases: {
      title: "My Cases",
      subtitle: "Track the status and progress of all your cases and applications.",
      active: "Active",
      history: "History",
      noCases: "No cases yet.",
      noCasesDesc: "Start a new case from your main dashboard.",
    ...
    products: {
      ...
      "visto-b1-b2-reaplicacao": {
        label: "B1/B2 Reapplication",
        category: "Tourism/Business",
        subtitle: "Total focus on reversal",
        included: ["Negative Analysis", "Reapplication Strategy", "Interview Training"],
      },
      "visto-f1": {
        label: "F-1 Visa",
        category: "Student/Academic",
        subtitle: "From I-20 to final approval",
        included: ["I-20 Guide", "SEVIS Checklist", "Student Training"],
      },
      "extensao-status": {
        label: "Extension of Status",
        category: "Extend Stay",
        subtitle: "Stay legal for longer",
        included: ["I-539 Guide", "Support Letter", "USCIS Checklist"],
      },
      "troca-status": {
        label: "Change of Status",
        category: "Change Visa",
        subtitle: "Change visa without leaving the US",
        included: ["I-539 Guide", "Support Letter", "USCIS Checklist"],
      },
      "visto-f1-reaplicacao": {
        label: "F-1 Reapplication",
        category: "Student/Academic",
        subtitle: "Reverse your student denial",
        included: ["Negative Analysis", "Academic Strategy", "Interview Training"],
      },
      "mentoria-individual": {
        label: "Bronze Package",
        category: "Mentoring",
        subtitle: "1 Mock Interview",
        included: ["1 Training Lesson", "Question Mockup"],
      },
      "mentoria-bronze": {
        label: "Silver Package",
        category: "Mentoring",
        subtitle: "2 Mock Interviews",
        included: ["2 Training Lessons", "Profile Analysis", "Immediate Feedback"],
      },
      "mentoria-silver": {
        label: "Silver Package (F1)",
        category: "Mentoring",
        subtitle: "2 Mock Interviews",
        included: ["2 Training Lessons", "Profile Analysis", "Immediate Feedback"],
      },
      "mentoria-gold": {
        label: "Gold Package",
        category: "VIP Mentoring",
        subtitle: "3 Mocks + Full Review",
        included: ["3 Training Lessons", "Response Strategy", "VIP Support"],
      },
      "mentoria-negativa-consular": {
        label: "Refusal Analysis",
        category: "Consultancy",
        subtitle: "Technical post-negative analysis",
        included: ["Detailed Analysis", "45 min with specialist", "Action Plan"],
      },
      "consultoria-f1-negativa": {
        label: "F-1 Post-Negative Mentoring",
        category: "Consultancy",
        subtitle: "Reversal strategy for students",
        included: ["Tie Analysis", "45 min with specialist", "New Strategy"],
      },
      "consultoria-especialista": {
        label: "Specialist Consultancy",
        category: "Consultancy",
        subtitle: "Personalized service",
        included: ["45 min with specialist", "Document Analysis"],
      },
    },
  },
  sidebar: {
