    ...
    product: {
        ...
        paymentMethods: {
            ...
            parcelow: {
                label: "Installments",
                sublabel: "BRL",
                notice: "Pay in up to **12 fixed installments**. Value converted to BRL with installment fees. Guaranteed exchange rate.",
                cpfLabel: "Cardholder's CPF",
                cpfPlaceholder: "000.000.000-00",
                cpfRequired: "Provide a valid CPF to proceed with installment payment.",
                cpfNotice: "Required for invoice issuance."
            },
            zelle: {
                label: "Zelle",
                sublabel: "USD",
