const dashboard = {
  dashboard: {
    ...
    passportUploadModal: {
      title: "Identificación con Pasaporte",
      description: "Sostenga el pasaporte abierto al lado de su rostro",
      closeTitle: "Cerrar y volver",
      reqHoldingPassport: "Sosteniendo el Pasaporte",
      reqLegibleData: "Datos Legibles",
      reqWhiteBackground: "Fundo Blanco",
      reqNoGlasses: "Sin Anteojos",
      reqVisibleFaceId: "Rostro e ID Visibles",
      reqGoodLighting: "Buena Iluminación",
      uploadPhoto: "Cargar Foto",
      changePhoto: "Cambiar Foto",
      supportedFormats: "Formatos soportados: JPG, PNG. Máximo 5MB.",
      confirmAndProceed: "Confirmar y Continuar",
      sending: "Enviando...",
      errorMaxSize: "La foto debe tener un máximo de 5MB.",
      successUpload: "¡Foto enviada con éxito!",
      errorUpload: "Error al enviar la foto: {error}"
    },
    activeProcesses: "Tus Casos Activos",
    selectProcess: "Seleccionar Caso",
    getProcesses: "Obtener Casos",
    ...
    myProcesses: "Mis Casos",
    trackStatus: "Sigue el estado de todas tus guías y solicitudes.",
    noActiveProcesses: "Aún no tienes casos activos.",
    progress: "Progreso",
    ...
    myCases: {
      ...
      noCasesDesc: "Comienza un nuevo caso desde tu panel principal.",
    ...
    products: {
      "visto-b1-b2": {
        label: "Visa B1/B2",
        category: "Turismo/Negocios",
        subtitle: "Guía paso a paso completa",
        included: ["Guía DS-160", "Checklist de Documentos", "Simulador de Entrevista"],
      },
      "visto-b1-b2-reaplicacao": {
        label: "Reaplicación B1/B2",
        category: "Turismo/Negocios",
        subtitle: "Foco total en la reversión",
        included: ["Análisis de Negativa", "Estrategia de Reaplicación", "Entrenamiento de Entrevista"],
      },
      "visto-f1": {
        label: "Visa F-1",
        category: "Estudiante/Académico",
        subtitle: "Del I-20 a la aprobación final",
        included: ["Guía I-20", "Checklist SEVIS", "Entrenamiento Estudiantil"],
      },
      "visto-f1-reaplicacao": {
        label: "Reaplicación F-1",
        category: "Estudiante/Académico",
        subtitle: "Revierta su negativa de estudiante",
        included: ["Análisis de Negativa", "Estrategia Académica", "Entrenamiento de Entrevista"],
      },
      "extensao-status": {
        label: "Extensión de Status",
        category: "Extender Estancia",
        subtitle: "Permanezca legal por más tiempo",
        included: ["Guía I-539", "Carta de Apoyo", "Checklist USCIS"],
      },
      "troca-status": {
        label: "Cambio de Status",
        category: "Cambio de Visa",
        subtitle: "Cambie de visa sin salir de EE. UU.",
        included: ["Guía I-539", "Carta de Apoyo", "Checklist USCIS"],
      },
      "mentoria-individual": {
        label: "Paquete Bronze",
        category: "Mentoría",
        subtitle: "1 Simulación de Entrevista",
        included: ["1 Clase de Entrenamiento", "Simulacro de preguntas"],
      },
      "mentoria-bronze": {
        label: "Paquete Plata",
        category: "Mentoría",
        subtitle: "2 Simulaciones de Entrevista",
        included: ["2 Clases de Entrenamiento", "Análisis de perfil", "Feedback"],
      },
      "mentoria-silver": {
        label: "Paquete Plata (F1)",
        category: "Mentoría",
        subtitle: "2 Simulaciones de Entrevista",
        included: ["2 Clases de Entrenamiento", "Análisis de perfil", "Feedback"],
      },
      "mentoria-gold": {
        label: "Paquete Gold",
        category: "Mentoría VIP",
        subtitle: "3 Simulaciones + Revisión",
        included: ["3 Clases de Entrenamiento", "Estrategia", "Soporte VIP"],
      },
      "mentoria-negativa-consular": {
        label: "Análisis de Rechazo",
        category: "Consultoría",
        subtitle: "Análisis técnico post-negativa",
        included: ["Análisis detallado", "45 min con especialista", "Plan de acción"],
      },
      "consultoria-f1-negativa": {
        label: "Mentoría Pós-Negativa F-1",
        category: "Consultoría",
        subtitle: "Estrategia de reversión",
        included: ["Análisis de vínculos", "45 min con especialista", "Nueva estrategia"],
      },
      "consultoria-especialista": {
        label: "Consultoría Especialista",
        category: "Consultoría",
        subtitle: "Atención personalizada",
        included: ["45 min con especialista", "Análisis documental"],
      },
    },
  },
  sidebar: {
