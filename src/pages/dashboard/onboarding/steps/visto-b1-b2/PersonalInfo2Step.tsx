...
export const PersonalInfo2Step = ({ register, watch, setValue, lang, t, errors }: StepProps) => {
    const ds = t.ds160;
    ...
    return (
        <div className="space-y-6 fade-in">
            <h2 className="font-display text-lg font-semibold text-foreground">{ds.personal2.title[lang]}</h2>

            <div className="space-y-4">
                <div className="space-y-2">
                    <Label htmlFor="nationalityInfo">{ds.personal2.nationality[lang]} *</Label>
                    <Input
                        id="nationalityInfo"
                        {...register("nationalityInfo")}
                        onChange={(e) => setValue("nationalityInfo", e.target.value.replace(/[^a-zA-ZáéíóúàèìòùâêîôûãõçÁÉÍÓÚÀÈÌÒÙÂÊÎÔÛÃÕÇ\s]/g, ""))}
                    />
                </div>
                ...
                <div className="space-y-3">
                    ...
                    >
                        <div className="flex items-center space-x-2">
                            ...
                            <Label htmlFor="other-nat-yes">{lang === 'pt' ? 'Sim' : 'Yes'}</Label>
                        </div>
                        <div className="flex items-center space-x-2">
                            <RadioGroupItem value="no" id="other-nat-no" />
                            <Label htmlFor="other-nat-no">{lang === 'pt' ? 'Não' : 'No'}</Label>
                        </div>
                    </RadioGroup>
                ...
                <div className="space-y-3">
                    ...
                    >
                        <div className="flex items-center space-x-2">
                            ...
                            <Label htmlFor="other-pass-yes">{lang === 'pt' ? 'Sim' : 'Yes'}</Label>
                        </div>
                        <div className="flex items-center space-x-2">
                            <RadioGroupItem value="no" id="other-pass-no" />
                            <Label htmlFor="other-pass-no">{lang === 'pt' ? 'Não' : 'No'}</Label>
                        </div>
                    </RadioGroup>
                    {hasNationalityPassport === "yes" && (
                        <Input {...register("nationalityPassportNumber")} className="mt-2" />
                    )}
                </div>
                ...
                <div className="space-y-3">
                    ...
                    >
                        <div className="flex items-center space-x-2">
                            ...
                            <Label htmlFor="perm-res-yes">{lang === 'pt' ? 'Sim' : 'Yes'}</Label>
                        </div>
                        <div className="flex items-center space-x-2">
                            <RadioGroupItem value="no" id="perm-res-no" />
                            <Label htmlFor="perm-res-no">{lang === 'pt' ? 'Não' : 'No'}</Label>
                        </div>
                    </RadioGroup>
                    {isPermanentResidentOtherCountry === "yes" && (
                        <div className="mt-2 space-y-2 scale-in-center">
                            <Label htmlFor="permResCountryDetails">{lang === 'pt' ? 'Informe os detalhes da residência:' : 'Enter residence details:'} *</Label>
                            <Input
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        {...register("nationalID", {
                            ...
                            pattern: {
                                value: /^[0-9]{11}$/,
                                message: lang === 'pt' ? "CPF deve ter exatamente 11 números" : "CPF must be exactly 11 digits"
                            }
                        })}
                        maxLength={11}
                        onChange={(e) => {
                    ...
                    />
                    {errors?.nationalID && (
                        <p className="text-xs text-destructive mt-1">{errors.nationalID.message || (lang === 'pt' ? "Campo obrigatório" : "Required field")}</p>
                    )}
                </div>
                <div className="space-y-2">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            />
                            <label htmlFor="nationalIDDoesNotApply" className="text-xs text-muted-foreground cursor-pointer">
                                Does Not Apply
                            </label>
                        </div>
                    </div>
                    <Input
                        ...
                        {...register("nationalID", {
                            ...
                            pattern: watch("nationalIDDoesNotApply") ? undefined : {
                                value: /^[0-9]{11}$/,
                                message: lang === 'pt' ? "CPF deve ter exatamente 11 números" : "CPF must be exactly 11 digits"
                            }
                        })}
                ...
                <div className="space-y-2">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            />
                            <label htmlFor="ssnDoesNotApply" className="text-xs text-muted-foreground cursor-pointer">
                                Does Not Apply
                            </label>
                        </div>
                    </div>
                ...
                <div className="space-y-2">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            />
                            <label htmlFor="taxIDDoesNotApply" className="text-xs text-muted-foreground cursor-pointer">
                                Does Not Apply
                            </label>
                        </div>
                    </div>
