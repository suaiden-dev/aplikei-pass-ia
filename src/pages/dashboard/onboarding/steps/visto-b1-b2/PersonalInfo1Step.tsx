...
export const PersonalInfo1Step = ({ register, watch, setValue, lang, t }: StepProps) => {
    const ds = t.ds160;
    ...
    return (
        <div className="space-y-6 fade-in">
            <h2 className="font-display text-lg font-semibold text-foreground">{ds.personal1.title[lang]}</h2>

            <div className="space-y-3 pb-6 border-b border-border">
                <Label htmlFor="interviewLocation">{ds.interview.location[lang]} *</Label>
                <Select
                ...
                >
                    <SelectTrigger id="interviewLocation" className="w-full mt-1">
                        <SelectValue placeholder={lang === 'pt' ? 'Selecione o local...' : 'Select location...'} />
                    </SelectTrigger>
                    <SelectContent>
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            onChange={(e) => setValue("lastName", e.target.value.replace(/[^a-zA-ZáéíóúàèìòùâêîôûãõçÁÉÍÓÚÀÈÌÒÙÂÊÎÔÛÃÕÇ\s]/g, ""))}
                        />
                    </div>
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            onChange={(e) => setValue("firstName", e.target.value.replace(/[^a-zA-ZáéíóúàèìòùâêîôûãõçÁÉÍÓÚÀÈÌÒÙÂÊÎÔÛÃÕÇ\s]/g, ""))}
                        />
                        <p className="text-xs text-muted-foreground mt-1">{ds.personal1.fullNameHelper[lang]}</p>
                    </div>
                </div>
                <div className="space-y-2 mt-2">
                    <Label htmlFor="fullNamePassport">{ds.personal1.fullNamePassport[lang]}</Label>
            ...
            <div className="space-y-3">
                ...
                >
                    <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="telecode-yes">{lang === 'pt' ? 'Sim' : 'Yes'}</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                ...
                {hasTelecode === "yes" && (
                    <div className="mt-2 space-y-2 scale-in-center">
                        <Label htmlFor="telecodeValue">{lang === 'pt' ? 'Informe o telecódigo:' : 'Enter telecode:'} *</Label>
                        <Input
                            id="telecodeValue"
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 border-t border-border pt-6">
                <div className="space-y-3">
                    ...
                    >
                        <div className="flex items-center space-x-2">
                            ...
                            <Label htmlFor="gender-male">{ds.personal1.genderOptions.male[lang]}</Label>
                        </div>
                        <div className="flex items-center space-x-2">
                            <RadioGroupItem value="female" id="gender-female" />
                            <Label htmlFor="gender-female">{ds.personal1.genderOptions.female[lang]}</Label>
                        </div>
                    </RadioGroup>
                </div>
                ...
                <div className="space-y-2">
                    ...
                    >
                        ...
                        <option value="married">{ds.personal1.maritalOptions.married[lang]}</option>
                        <option value="single">{ds.personal1.maritalOptions.single[lang]}</option>
                        <option value="widowed">{ds.personal1.maritalOptions.widowed[lang]}</option>
                        <option value="divorced">{ds.personal1.maritalOptions.divorced[lang]}</option>
                        <option value="separated">{ds.personal1.maritalOptions.separated[lang]}</option>
                    </select>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 border-t border-border pt-6">
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        id="birthCity"
                        {...register("birthCity")}
                        onChange={(e) => setValue("birthCity", e.target.value.replace(/[^a-zA-ZáéíóúàèìòùâêîôûãõçÁÉÍÓÚÀÈÌÒÙÂÊÎÔÛÃÕÇ\s]/g, ""))}
                    />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                    <Label htmlFor="birthCountry">{ds.personal1.countryBirth[lang]} *</Label>
