import { RiLoader4Line, RiSearchLine, RiShieldUserLine, RiUserLine } from "react-icons/ri";
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            ...
            <tbody>
              {isLoading ? (
                <tr>
                  <td colSpan={5} className="px-6 py-14 text-center text-text-muted font-bold">
                    ...
                    <tr key={user.id} className="border-b border-border">
                      ...
                      <td className="px-6 py-5">
                        <span className="inline-flex items-center px-3 py-1 rounded-full bg-bg-subtle border border-border text-[11px] font-black text-text-muted uppercase tracking-wider">
                          {(t.shared.roleLabels as any)[user.role || "customer"] || user.role}
                        </span>
                      </td>
