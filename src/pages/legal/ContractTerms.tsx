...
const ContractTerms = () => {
    ...
    return (
        <div className="container max-w-4xl py-12 px-4 sm:px-6 lg:px-8 bg-background min-h-screen">
            <div className="mb-8">
            ...
            <div className="prose prose-slate dark:prose-invert max-w-none space-y-6">
                ...
                <section>
                    <h2 className="text-xl font-semibold">1. Condições Gerais</h2>
                ...
                <section>
                    <h2 className="text-xl font-semibold">2. Responsabilidades do Solicitante</h2>
                ...
                <section>
                    <h2 className="text-xl font-semibold">3. Aceite Eletrônico e Veracidade das Imagens</h2>
                ...
                <section>
                    <h2 className="text-xl font-semibold">4. Foro</h2>
