...
function buildLabels(t: { onboardingPage: B1B2OnboardingLabels }): B1B2OnboardingLabels {
  return {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 mt-8">
        ...
        {stepIdx >= 10 ? (
          ...
          <div className="bg-card rounded-[32px] border border-border shadow-xl p-8 text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="w-16 h-16 bg-amber-500/10 text-amber-500 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-inner">
            ...
            <button
              onClick={handleNavigateToProcess}
              className="px-8 py-3 rounded-xl border border-border text-text-muted font-bold text-[10px] uppercase tracking-widest hover:bg-bg-subtle transition-all font-mono"
            >
          ...
          <div className="bg-card rounded-[32px] border border-border shadow-xl p-8 text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="w-16 h-16 bg-blue-500/10 text-blue-500 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-inner">
              <RiLoader4Line className="text-3xl animate-spin" />
            </div>
            <h3 className="text-xl font-black text-text mb-2 uppercase">
            ...
            <button
              onClick={handleNavigateToProcess}
              className="px-8 py-3 rounded-xl border border-border text-text-muted font-bold text-[10px] uppercase tracking-widest hover:bg-bg-subtle transition-all"
            >
              {labels.backToDashboard}
            </button>
          </div>
                ...
                <Form noValidate>
                  {hasVisibleErrors && (
                    <motion.div
                      ...
                      className="mb-8 p-5 rounded-2xl bg-red-500/10 border border-red-500/20 flex items-start gap-4"
                    >
                      ...
                      <div>
                        <h3 className="text-[11px] font-black text-red-500 uppercase tracking-widest mb-1">
                  ...
                  <div className="bg-card rounded-3xl border border-border shadow-xl shadow-black/5 overflow-hidden">
                    ...
                    {procStatus === 'awaiting_review' || currentStep > stepIdx ? (
                      <div className="px-6 sm:px-10 py-10 bg-bg-subtle border-t border-border flex flex-col items-center justify-center text-center">
                        {currentStep > stepIdx ? (
                          <div className="space-y-3">
                            <div className="w-12 h-12 rounded-2xl bg-emerald-500/10 text-emerald-500 flex items-center justify-center mx-auto shadow-sm">
                          ...
                          <div className="flex items-center gap-3 text-text-muted font-bold uppercase tracking-widest text-xs">
