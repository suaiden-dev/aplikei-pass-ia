...
export function B1B2CASVSchedulingStep({ procId, stepData, onComplete, onBack }: B1B2CASVSchedulingStepProps) {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      {/* ── Consulado Info Card ── */}
      <div className="bg-card rounded-[28px] border border-border shadow-xl shadow-border/40 overflow-hidden">
        <div className="px-8 py-5 border-b border-border flex items-center gap-3">
          ...
          <h3 className="text-xs font-black text-text-muted uppercase tracking-widest">{t.onboardingPage.scheduling.yourConsulate}</h3>
        </div>
      ...
      <div className="bg-card rounded-[28px] border border-border shadow-xl shadow-border/40 overflow-hidden">
        <div className="px-8 py-5 border-b border-border flex items-center gap-3">
          ...
          <div>
            <h3 className="text-xs font-black text-text-muted uppercase tracking-widest">{t.onboardingPage.scheduling.preferredDate}</h3>
