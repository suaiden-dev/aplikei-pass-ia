        ...
        <div className="mt-5 space-y-4 rounded-md border border-primary/20 bg-primary/5 p-4 shadow-sm">
          ...
          <div className="pt-4 flex justify-center">
            <a 
              ...
              target="_blank" 
              rel="noreferrer" 
              className="inline-flex items-center justify-center gap-2 bg-slate-900 border-none hover:bg-slate-800 text-white font-bold text-[11px] uppercase tracking-widest px-8 py-4 rounded-xl shadow-lg shadow-black/10 transition-all w-full md:w-auto hover:scale-[1.02]"
            >
              <FileText className="w-4 h-4" />
              {lang === 'pt' ? 'Acessar Portal do Consulado (CEAC)' : lang === 'es' ? 'Acceder al Portal del Consulado (CEAC)' : 'Access Consulate Portal (CEAC)'}
