      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <button
          ...
          className={`p-6 rounded-[28px] border-2 transition-all text-left flex flex-col gap-4 ${
            method === "credit_card" ? "border-primary bg-primary/5 shadow-lg shadow-primary/10" : "border-border bg-card hover:border-border"
          }`}
        >
        ...
        <button
          ...
          className={`p-6 rounded-[28px] border-2 transition-all text-left flex flex-col gap-4 ${
            method === "boleto" ? "border-primary bg-primary/5 shadow-lg shadow-primary/10" : "border-border bg-card hover:border-border"
          }`}
        >
