...
export default function Footer() {
  ...
  return (
    <footer className="bg-highlight text-white pt-40 pb-20 px-8 lg:px-16">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-4 gap-24 mb-24 border-b border-white/10 pb-24">
        <div>
          <div className="flex items-center gap-3 mb-10">
            <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center font-black text-2xl text-highlight">A</div>
        ...
        <div>
          <h4 className="font-bold text-sm mb-10 uppercase tracking-[0.2em] text-white">Plataforma</h4>
          <ul className="space-y-5 text-white/70 font-medium">
            <li><Link to="/como-funciona" className="hover:text-white transition-colors">Como funciona</Link></li>
            <li><Link to="/seguranca" className="hover:text-white transition-colors">Segurança de Dados</Link></li>
            <li><Link to="/ajuda" className="hover:text-white transition-colors">Central de Ajuda</Link></li>
          </ul>
        </div>
        <div>
          <h4 className="font-bold text-sm mb-10 uppercase tracking-[0.2em] text-white">Contato</h4>
          <ul className="space-y-6 text-white/70 font-medium">
            <li className="flex items-center gap-4">
              <span className="material-symbols-outlined text-white text-2xl">email</span>
