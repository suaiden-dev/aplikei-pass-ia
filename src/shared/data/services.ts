...
export const servicesData: ServiceMeta[] = [
  ...
  {
    slug: "dependent-cos",
    title: "Vaga de Dependente (COS)",
    subtitle: "Adicione um co-requerente ao processo I-539",
    price: "US$ 100,00",
    ...
    description: "Slot adicional para cônjuge ou filho no processo de Troca de Status.",
    forWhom: ["Dependentes no mesmo status de visto"],
    notForWhom: [],
    included: ["Slot extra no formulário I-539", "Revisão dos documentos do familiar", "Inclusão no pacote final"],
    requirements: [],
    dependentPrice: "US$ 0,00",
    steps: [],
    faq: [],
  },
  {
    ...
    processType: "Mudança Interna",
    heroIconName: "MdGroupAdd",
    description: "Slot adicional para cônjuge ou filho no processo de Extensão de Status.",
    forWhom: ["Dependentes no mesmo status de visto"],
    notForWhom: [],
    included: ["Slot extra no formulário I-539", "Revisão dos documentos do familiar", "Inclusão no pacote final"],
    requirements: [],
