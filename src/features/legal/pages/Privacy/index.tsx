        ...
        <LegalLayout>
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="max-w-4xl">
                    ...
                    <p className="mt-5 max-w-2xl text-base leading-relaxed text-slate-500 italic sm:text-lg">
                        Veja como coletamos, usamos e protegemos suas informações.
                    </p>
                </div>
                ...
                <div className="mt-12 space-y-10">
                    {dbTerms.map((term, i) => (
                        <section key={term.id} className="group">
                            ...
                            <div
                                className="prose prose-slate max-w-none pl-11 text-slate-600 prose-headings:text-slate-900 prose-a:text-primary prose-strong:text-slate-900 [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5"
                    ...
                    {dbTerms.length === 0 && (
                        <p className="py-16 text-center text-sm text-slate-400">
                            Nenhuma política publicada no momento.
                        </p>
                    )}
                </div>
            </div>
