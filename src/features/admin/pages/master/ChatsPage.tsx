...
const chatRecords = [
  { id: "CH-01", customer: "Ana Silva",    channel: "WhatsApp" as const, lastMessage: "Quando sai o visto?",     waitingMinutes: 12, unreadCount: 3, priority: "high"   as const, assignedTo: "Sarah",  status: "open"     as const },
  { id: "CH-02", customer: "Carlos Costa", channel: "Instagram" as const, lastMessage: "Preciso do I-20.",       waitingMinutes: 45, unreadCount: 1, priority: "medium" as const, assignedTo: "Bruno",  status: "waiting"  as const },
  { id: "CH-03", customer: "Mariana Lima", channel: "Site"      as const, lastMessage: "Documentos enviados.",   waitingMinutes:  5, unreadCount: 2, priority: "high"   as const, assignedTo: "Bianca", status: "open"     as const },
  { id: "CH-04", customer: "John Miller",  channel: "WhatsApp" as const, lastMessage: "Ok, aguardo retorno.",   waitingMinutes: 90, unreadCount: 0, priority: "low"    as const, assignedTo: "Sarah",  status: "resolved" as const },
  { id: "CH-05", customer: "Julia Rocha",  channel: "Site"      as const, lastMessage: "Qual o próximo passo?", waitingMinutes: 20, unreadCount: 1, priority: "medium" as const, assignedTo: "Bruno",  status: "open"     as const },
];
