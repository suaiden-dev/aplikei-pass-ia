...
const productRecords = [
  { id: "PRD-01", name: "Visto B1/B2 Premium", category: "Turismo", price: 4200, sales: 84, status: "active" as const, stock: 999 },
  { id: "PRD-02", name: "Consultoria F-1", category: "Estudante", price: 3200, sales: 41, status: "active" as const, stock: 999 },
  { id: "PRD-03", name: "Troca de Status", category: "Imigração", price: 5100, sales: 28, status: "active" as const, stock: 999 },
  { id: "PRD-04", name: "Extensão de Status", category: "Imigração", price: 2800, sales: 16, status: "low-stock" as const, stock: 3 },
  { id: "PRD-05", name: "Mentoria Consular", category: "Preparação", price: 1800, sales: 62, status: "draft" as const, stock: 12 },
];
