...
const localCopy = {
  pt: {
    titleAccent: "para escalar vistos consulares",
    secondaryCta: "Ver soluções",
    proof: [
      { value: "-70%", label: "tempo de preparação" },
      { value: "3x", label: "mais casos por equipe" },
      { value: "99%", label: "padrão de entrega" },
    ],
    panel: {
      title: "Operação consular",
      subtitle: "Fluxos, clientes e documentos",
      live: "Live",
      aiTitle: "IA aplicada",
      aiSubtitle: "automacao de processos",
      securityTitle: "Dados protegidos",
      securitySubtitle: "Upload seguro e trilha de auditoria",
    },
    rows: ["Checklist ativo", "DS-160 em revisão", "Pacote documental"],
    solutions: {
      kicker: "Soluções",
      title: "A mesma base visual da nova homepage, aplicada aos serviços.",
      lead: "Organize a oferta por capacidade operacional, deixando claro o valor de cada módulo para escritórios e assessorias.",
    },
    performance: {
      kicker: "Performance",
      items: [
        { title: "Escala operacional", text: "Menos controle manual e mais previsibilidade por etapa, responsável e status." },
        { title: "Portal do cliente", text: "Coleta de informações, documentos e pendências em uma experiência simples." },
      ],
    },
    security: {
      kicker: "Segurança",
  ...
  en: {
    titleAccent: "to scale consular visas",
    secondaryCta: "See solutions",
    proof: [
      { value: "-70%", label: "preparation time" },
      { value: "3x", label: "more cases per team" },
      { value: "99%", label: "delivery standard" },
    ],
    panel: {
      title: "Consular operation",
      subtitle: "Flows, clients and documents",
      live: "Live",
      aiTitle: "Applied AI",
      aiSubtitle: "Form and letter automation",
      securityTitle: "Protected data",
      securitySubtitle: "Secure upload and audit trail",
    },
    rows: ["Active checklist", "DS-160 in review", "Document package"],
    solutions: {
      kicker: "Solutions",
      title: "The same visual foundation as the new homepage, applied to services.",
      lead: "Organize the offer by operational capability and make each module's value clear for firms and consultancies.",
    },
    performance: {
      kicker: "Performance",
      items: [
        { title: "Operational scale", text: "Less manual control and more predictability by stage, owner and status." },
        { title: "Client portal", text: "Information, document and pending item collection in a simple experience." },
      ],
    },
    security: {
      kicker: "Security",
  ...
  es: {
    titleAccent: "para escalar visas consulares",
    secondaryCta: "Ver soluciones",
    proof: [
      { value: "-70%", label: "tiempo de preparación" },
      { value: "3x", label: "más casos por equipo" },
      { value: "99%", label: "estándar de entrega" },
    ],
    panel: {
      title: "Operación consular",
      subtitle: "Flujos, clientes y documentos",
      live: "Live",
      aiTitle: "IA aplicada",
      aiSubtitle: "Automatización de formularios y cartas",
      securityTitle: "Datos protegidos",
      securitySubtitle: "Carga segura y trazabilidad",
    },
    rows: ["Checklist activo", "DS-160 en revisión", "Paquete documental"],
    solutions: {
      kicker: "Soluciones",
      title: "La misma base visual de la nueva homepage, aplicada a servicios.",
      lead: "Organice la oferta por capacidad operativa y deje claro el valor de cada módulo para firmas y asesorías.",
    },
    performance: {
      kicker: "Rendimiento",
      items: [
        { title: "Escala operativa", text: "Menos control manual y más previsibilidad por etapa, responsable y estado." },
        { title: "Portal del cliente", text: "Recolección de información, documentos y pendientes en una experiencia simple." },
      ],
    },
    security: {
      kicker: "Seguridad",
