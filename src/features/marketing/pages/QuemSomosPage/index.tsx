...
const whoCopy = {
  pt: {
    ...
    showcaseSubtitle: "Produtos, checkout, processos e IA integrados",
    missionKicker: "Missão",
    pillarsKicker: "Pilares",
    metricsKicker: "Impacto",
    cards: [
      { title: "Produtos digitais", text: "Venda serviços com preço, escopo e fluxo organizados por produto." },
  ...
  en: {
    ...
    showcaseSubtitle: "Products, checkout, processes and AI integrated",
    missionKicker: "Mission",
    pillarsKicker: "Pillars",
    metricsKicker: "Impact",
    cards: [
      { title: "Digital products", text: "Sell services with clear pricing, scope and product-specific flows." },
  ...
  es: {
    ...
    showcaseSubtitle: "Productos, checkout, procesos e IA integrados",
    missionKicker: "Misión",
    pillarsKicker: "Pilares",
    metricsKicker: "Impacto",
    cards: [
      { title: "Productos digitales", text: "Venda servicios con precio, alcance y flujo organizados por producto." },
