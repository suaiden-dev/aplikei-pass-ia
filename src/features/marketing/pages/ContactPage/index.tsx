...
const contactCopy = {
  pt: {
    badge: "Contato comercial",
    accent: "sobre sua operação consular",
    lead: "Conte para nossa equipe como seu escritório trabalha hoje. A partir disso, mostramos onde a Aplikei reduz retrabalho, centraliza casos e acelera a entrega.",
    primaryCta: "Enviar mensagem",
    secondaryCta: "Ver canais",
    cards: [
      { title: "Resposta consultiva", text: "Entendemos seu volume, equipe e gargalos antes de propor um caminho." },
      { title: "Demonstração guiada", text: "Mostramos os fluxos de vistos, page builder, checkout e portal do cliente." },
      { title: "Dados protegidos", text: "O contato inicial já segue o mesmo padrão de privacidade da plataforma." },
    ],
    strip: [
      { label: "Tempo de resposta", value: "1 dia útil" },
      { label: "Formato", value: "Demo B2B" },
      { label: "Foco", value: "Escala consular" },
    ],
  },
  en: {
    badge: "Sales contact",
    accent: "about your consular operation",
    lead: "Tell our team how your firm works today. From there, we show where Aplikei cuts rework, centralizes cases and speeds up delivery.",
    primaryCta: "Send message",
    secondaryCta: "See channels",
    cards: [
      { title: "Consultative response", text: "We understand your volume, team and bottlenecks before proposing a path." },
      { title: "Guided demo", text: "We show visa workflows, page builder, checkout and the client portal." },
    ...
    strip: [
      ...
      { label: "Focus", value: "Consular scale" },
    ],
  },
  es: {
    badge: "Contacto comercial",
    accent: "sobre su operación consular",
    lead: "Cuente a nuestro equipo cómo trabaja su firma hoy. A partir de eso, mostramos dónde Aplikei reduce retrabajo, centraliza casos y acelera la entrega.",
    primaryCta: "Enviar mensaje",
    secondaryCta: "Ver canales",
    cards: [
      { title: "Respuesta consultiva", text: "Entendemos su volumen, equipo y cuellos de botella antes de proponer un camino." },
      { title: "Demo guiada", text: "Mostramos flujos de visas, page builder, checkout y portal del cliente." },
