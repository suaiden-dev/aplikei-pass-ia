const dashboard = {
  dashboard: {
    ...
    myCases: {
      ...
      subtitle: "Acompanhe o status e o progresso de todos os seus processos e solicitações.",
      active: "Ativos",
      history: "Histórico",
      noCases: "Nenhum caso ainda.",
      noCasesDesc: "Comece um novo processo a partir do seu painel principal.",
    ...
    products: {
      ...
      "visto-b1-b2-reaplicacao": { label: "Visto B1/B2 Reaplicação", category: "Turismo/Negócios" },
      "visto-f1": { label: "Visto F-1", category: "Estudante/Acadêmico" },
      "extensao-status": { label: "Extensão de Status", category: "Prorrogação" },
      "troca-status": { label: "Troca de Status", category: "Alteração de Visto" },
    },
  },
  sidebar: {
    dashboard: "Painel",
