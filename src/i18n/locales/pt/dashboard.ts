const dashboard = {
  dashboard: {
    ...
    noActiveProcesses: "Você ainda não tem processos ativos.",
    progress: "Progresso",
    ...
    myCases: {
      ...
      noCasesDesc: "Inicie um novo processo em seu painel principal.",
    ...
    products: {
      ...
      "extensao-status": { label: "Extensão de Status", category: "Estender Estadia" },
      "troca-status": { label: "Troca de Status", category: "Mudar Visto" },
    },
  },
  sidebar: {
    dashboard: "Painel",
