...
export const translations = {
  ...
  howItWorksPage: {
    title: {
      en: "Your 5-Step Journey to Success",
      pt: "Sua Jornada de 5 Passos para o Sucesso",
      es: "Tu Viaje de 5 Pasos hacia o Éxito",
    },
    subtitle: {
      en: "A transparent and efficient legal-tech process designed for the modern world. Professional results, simplified.",
      pt: "Um processo legal-tech transparente e eficiente projetado para o mundo moderno. Resultados profissionais, simplificados.",
      es: "Un proceso legal-tech transparente y eficiente diseñado para el mundo moderno. Resultados profesionales, simplificados.",
    },
    step: { en: "Step", pt: "Passo", es: "Paso" },
    steps: [
      {
        title: { en: "Pre-purchase Consultation", pt: "Consulta Pré-compra", es: "Consulta Pre-compra" },
        desc: {
          en: "Explore our curated list of services. Our tools help you find the exact fit for your specific requirements.",
          pt: "Explore nossa lista selecionada de serviços. Nossas ferramentas ajudam você a encontrar o ajuste exato para suas necessidades específicas.",
          es: "Explora nuestra lista seleccionada de servicios. Nuestras herramientas te ayudan a encontrar el ajuste exacto para tus requisitos específicos.",
        },
      },
      {
        title: {
          en: "Sign up & Agreements",
          pt: "Cadastro e Acordos",
          es: "Registro y Acuerdos",
        },
        desc: {
          en: "Create your secure account and review terms. Everything is handled digitally with legal-grade security.",
          pt: "Crie sua conta segura e revise os termos. Tudo é tratado digitalmente com segurança de nível jurídico.",
          es: "Crea tu cuenta segura y revisa los términos. Todo se maneja digitalmente com seguridad de nivel legal.",
        },
      },
      {
        title: { en: "Secure Payment", pt: "Pagamento Seguro", es: "Pago Seguro" },
        desc: {
          en: "Transparent upfront pricing with zero hidden fees. We use encrypted processing for your peace of mind.",
          pt: "Preços iniciais transparentes, sem taxas ocultas. Usamos processamento criptografado para sua tranquilidade.",
          es: "Precios iniciales transparentes sin cargos ocultos. Usamos procesamiento encriptado para tu tranquilidad.",
        },
      },
      {
        title: {
          en: "AI-Powered Onboarding",
          pt: "Onboarding com IA",
          es: "Onboarding con IA",
        },
        desc: {
          en: "Our intelligent assistant guides you through a dynamic questionnaire to capture all necessary details.",
          pt: "Nosso assistente inteligente guia você através de um questionário dinâmico para capturar todos os detalhes necessários.",
          es: "Nuestro asistente inteligente te guía a través de un cuestionario dinámico para capturar todos los detalles necesarios.",
        },
      },
      {
        title: {
          en: "Final Package Delivery",
          pt: "Entrega do Pacote Final",
          es: "Entrega del Paquete Final",
        },
        desc: {
          en: "Your customized, organized documents are delivered directly to your portal in professional PDF format.",
          pt: "Seus documentos personalizados e organizados são entregues diretamente no seu portal em formato PDF profissional.",
          es: "Tus documentos personalizados y organizados se entregan directamente en tu portal en formato PDF profesional.",
        },
      },
    ],
    youBuy: {
      en: "Certified Documents",
      pt: "Documentos Certificados",
      es: "Documentos Certificados",
    },
    youBuyDesc: {
      en: "Fully compliant documents ready for signature and submission to relevant authorities.",
      pt: "Documentos totalmente em conformidade, prontos para assinatura e submissão às autoridades competentes.",
      es: "Documentos totalmente conformes listos para firma y presentación ante las autoridades pertinentes.",
    },
    bonusAI: { en: "Expert Review", pt: "Revisão Especializada", es: "Revisión Especializada" },
    bonusAIDesc: {
      en: "Every AI-generated draft is vetted to ensure accuracy and compliance with current standards.",
      pt: "Cada rascunho gerado por IA é revisado para garantir precisão e conformidade com os padrões atuais.",
      es: "Cada borrador generado por IA se revisa para garantizar precisión y cumplimiento con los estándares actuales.",
    },
    bonusN1: {
      en: "Ongoing Support",
      pt: "Suporte Contínuo",
    ...
    bonusN1Desc: {
      en: "Access to our dashboard for revisions, storage, and customer support whenever you need it.",
      pt: "Acesso ao nosso dashboard para revisões, armazenamento e suporte ao cliente sempre que precisar.",
      es: "Acceso a nuestro tablero para revisiones, almacenamiento y soporte al cliente cuando lo necesites.",
    },
    aiDoesTitle: {
    ...
    aiDoes: {
      en: [
        "Instantly scans thousands of legal precedents",
        "Identifies structural inconsistencies in seconds",
        "Generates precise drafts based on your inputs",
      ],
      pt: [
        "Verifica instantaneamente milhares de precedentes",
        "Identifica inconsistências estruturais em segundos",
        "Gera rascunhos precisos com base em suas entradas",
      ],
      es: [
        "Escanea instantáneamente miles de precedentes legales",
        "Identifica inconsistencias estructurales en segundos",
        "Genera borradores precisos basados en tus entradas",
      ],
    },
    aiDoesNot: {
      en: [
        "Does not replace final human review",
        "Cannot provide subjective emotional advice",
        "Never files documents without your explicit consent",
      ],
      pt: [
        "Não substitui a revisão humana final",
        "Não pode fornecer aconselhamento emocional subjetivo",
        "Nunca envia documentos sem o seu consentimento explícito",
      ],
      es: [
        "No reemplaza la revisión humana final",
        "No puede proporcionar asesoramiento emocional subjetivo",
        "Nunca presenta documentos sin su consentimiento explícito",
      ],
    },
    aiHelps: {
      en: "✅ AI helps you:",
  ...
  serviceDetail: {
    ...
    steps: {
      en: "Your 7-Step Journey",
      pt: "Sua Jornada de 7 Passos",
      es: "Tu Jornada de 7 Pasos",
    },
    faq: {
      en: "Frequently asked questions",
      pt: "Perguntas frequentes",
    ...
    prepareDocs: {
      en: "Prepare these documents before you start",
      pt: "Prepare esses documentos antes de começar",
      es: "Prepare estos documentos antes de comenzar",
    },
    guidedJourney: {
      en: "Complete guided journey",
      pt: "Jornada guiada completa",
      es: "Jornada guiada completa",
    },
    legalDisclaimer: {
      en: "Legal Disclaimer",
      pt: "Aviso Legal",
  ...
  homeFaq: {
    q1: {
      ...
      es: "¿Cuánto tiempo tengo acceso a la herramienta de IA?",
    },
    a1: {
      en: "You maintain access to our platform throughout your process, until your visa application is complete.",
      pt: "Você mantém acesso à nossa plataforma durante todo o seu processo, até a conclusão da sua aplicação para o visto.",
      es: "Mantienes acceso a nuestra plataforma durante todo tu proceso, hasta que se complete tu solicitud de visa.",
    },
    q2: {
      en: "What types of visa do you cover today?",
      pt: "Quais tipos de visto vocês cobrem hoje?",
      es: "¿Qué tipos de visa cubren hoy?",
    },
    a2: {
      en: "Currently we focus on Tourist Visas (B1/B2), Student Visas (F-1) and Visa Renewals.",
      pt: "Atualmente focamos em Vistos de Turismo (B1/B2), Vistos de Estudante (F-1) e Renovação de Vistos.",
      es: "Actualmente nos enfocamos en Visas de Turista (B1/B2), Visas de Estudiante (F-1) e Renovación de Visas.",
    },
    q3: {
      en: "Is Aplikei a law firm?",
      pt: "A Aplikei é um escritório de advocacia?",
      es: "¿Es Aplikei um bufete de abogados?",
    },
    a3: {
      en: "No, Aplikei is a technological platform that facilitates the filling and organization of documents. We do not provide legal advice.",
      pt: "Não, a Aplikei é uma plataforma tecnológica que facilita o preenchimento e organização de documentos. Não prestamos consultoria jurídica.",
      es: "No, Aplikei es una plataforma tecnológica que facilita el llenado y organización de documentos. No brindamos asesoramiento legal.",
    },
  },
  ...
  dashboard: {
    ...
    selfieModal: {
      title: {
        en: "Initial Setup: Photos Required",
        pt: "Configuração Inicial: Fotos Necessárias",
        es: "Configuración Inicial: Fotos Requeridas",
      },
      desc: {
      ...
      step1Title: {
        ...
        pt: "Passo 1: Verificação de Identidade",
        es: "Paso 1: Verificación de Identidad",
      },
      step1Desc: {
        en: "Take a selfie holding your passport next to your face. Ensure the passport data is legible.",
        pt: "Tire uma selfie segurando seu passaporte ao lado do rosto. Certifique-se de que os dados do passaporte estejam legíveis.",
        es: "Tómate una selfie sosteniendo tu pasaporte al lado de tu cara. Asegúrate de que los datos del pasaporte sean legibles.",
      },
      step2Title: {
        en: "Step 2: Digital Visa Photo",
        pt: "Passo 2: Foto Digital para o Visto",
        es: "Paso 2: Foto Digital para la Visa",
      },
      step2Desc: {
        en: "Upload a recent 5x5cm digital photo with a plain white background, facing forward, with no glasses or hats.",
        pt: "Envie uma foto digital 5x5cm recente com fundo branco, olhando para a frente, sem óculos ou chapéus.",
        es: "Sube una foto digital de 5x5cm reciente con fondo blanco, mirando hacia adelante, sin gafas ni sombreros.",
      },
      uploadBtn: {
        en: "Select Photo",
        pt: "Selecionar Foto",
      ...
      selectVisaPhoto: {
        en: "Select 5x5 Photo",
        pt: "Selecionar Foto 5x5",
        es: "Seleccionar Foto 5x5",
      },
      nextStep: {
        en: "Next Step",
        pt: "Próximo Passo",
      ...
      success: {
        ...
        pt: "Fotos enviadas com sucesso!",
        es: "¡Fotos subidas con éxito!",
      },
    },
    activeProcesses: {
  ...
  servicesData: [
      ...
      included: {
        ...
        pt: [
          "Guia digital passo a passo com acesso vitalício",
          "Checklist completo de documentos",
          "Orientação para preenchimento do DS-160",
          "Dicas de preparação para a entrevista",
          "Bônus: IA durante o processo para organizar dados e documentos",
          "Bônus: Suporte Humano Operacional N1 (uso da plataforma e passos básicos)",
        ],
        es: [
          "Guía digital paso a paso con acceso vitalicio",
          "Checklist completo de documentos",
          "Orientación para el llenado del DS-160",
          "Consejos de preparación para la entrevista",
          "Bonus: IA durante el proceso para organizar datos y documentos",
          "Bonus: Soporte Humano Operacional N1 (uso de la plataforma y pasos básicos)",
        ],
      },
      notIncluded: {
        en: [
        ...
        pt: [
          ...
          "Preenchimento do formulário DS-160 por você",
        ...
        es: [
          ...
          "Llenado del formulario DS-160 por usted",
      ...
      steps: {
        ...
        pt: [
          ...
          "Inicie o onboarding guiado por IA",
          "Preencha seus dados e anexe os documentos",
          "Revise tudo e gere seu Pacote Final (PDF)",
          "Siga as instruções para agendamento e compareça à entrevista",
        ],
        es: [
          "Cree su cuenta y acepte los términos",
          "Elija el servicio y realice el pago",
          "Inicie el onboarding guiado por IA",
          "Complete sus datos y adjunte los documentos",
          "Revise todo y genere su Paquete Final (PDF)",
          "Siga las instrucciones para programar y asista a la entrevista",
        ],
      },
      faq: [
        {
          ...
          a: {
            en: "Aplikei provides a step-by-step guide and platform to help you fill it out correctly yourself, along with AI document organization.",
            pt: "A Aplikei oferece um guia passo a passo e uma plataforma para ajudar você a preencher corretamente, além da organização de documentos por IA.",
            es: "Aplikei proporciona una guía paso a paso y una plataforma para ayudarte a completarlo correctamente tú mismo, junto con la organización de documentos por IA.",
          },
        },
        {
          q: {
          ...
          a: {
            en: "No service can guarantee visa approval as the final decision rests solely with the consular officer. We provide the best tools to maximize your chances.",
            pt: "Nenhum serviço pode garantir a aprovação do visto, pois a decisão final cabe exclusivamente ao oficial consular. Oferecemos as melhores ferramentas para maximizar suas chances.",
            es: "Ningún servicio puede garantizar la aprobación de la visa, ya que la decisión final recae exclusivamente en el oficial consular. Brindamos las mejores herramientas para maximizar sus posibilidades.",
          },
        },
        {
          q: {
    ...
    },
    {
      ...
      description: {
        en: "Student — for foreigners applying from overseas. Complete professional guidance for your US educational journey.",
        pt: "Estudante — para estrangeiros aplicando de fora dos EUA. Orientação profissional completa para sua jornada educacional nos EUA.",
        es: "Estudiante — para extranjeros aplicando desde el exterior. Orientación profesional completa para su trayectoria académica en los EE. UU.",
      },
      forWhom: {
        en: [
          "Applicants currently outside the United States",
          "Individuals accepted into a SEVP-certified school",
          "First-time student visa applicants",
          "Those renewing their F-1 visa from abroad",
        ],
        pt: [
          "Candidatos que estão atualmente fora dos Estados Unidos",
          "Indivíduos aceitos em uma escola certificada pelo SEVP",
          "Candidatos ao visto de estudante pela primeira vez",
          "Aqueles que estão renovando seu visto F-1 do exterior",
        ],
        es: [
          "Solicitantes que se encuentran actualmente fuera de los Estados Unidos",
          "Individuos aceptados en una escuela certificada por SEVP",
          "Solicitantes de visa de estudiante por primera vez",
          "Aquellos que están renovando su visa F-1 desde el extranjero",
        ],
      },
      notForWhom: {
        en: [
          "Individuals already in the US on another visa",
          "Status change applicants within the US",
          "M-1 or J-1 visa category seekers",
        ],
        pt: [
          "Indivíduos que já estão nos EUA com outro visto",
          "Candidatos à mudança de status dentro dos EUA",
          "Buscadores das categorias de visto M-1 ou J-1",
        ],
        es: [
          "Individuos que ya se encuentran en los EE. UU. con otra visa",
          "Solicitantes de cambio de estatus dentro de los EE. UU.",
          "Personas que buscan las categorías de visa M-1 o J-1",
        ],
      },
      included: {
        en: [
          "I-20 Guidance: Expert review of your Form I-20 and school documentation.",
          "DS-160 Prep: Step-by-step assistance in completing your DS-160 form accurately.",
          "SEVIS Support: Guidance on SEVIS fee payments and official receipt management.",
          "Interview Tips: Comprehensive guide on common interview questions and strategies.",
        ],
        pt: [
          "Orientação I-20: Revisão especializada do seu Formulário I-20 e documentação escolar.",
          "Preparação DS-160: Assistência passo a passo no preenchimento correto do seu formulário DS-160.",
          "Suporte SEVIS: Orientação sobre pagamentos de taxas SEVIS e gestão de recibos oficiais.",
          "Dicas de Entrevista: Guia completo sobre perguntas comuns e estratégias de entrevista.",
        ],
        es: [
          "Orientación I-20: Revisión experta de su Formulario I-20 y documentación escolar.",
          "Prep. DS-160: Asistencia paso a paso para completar su formulario DS-160 con precisión.",
          "Soporte SEVIS: Orientación sobre pagos de tarifas SEVIS y gestión de recibos oficiales.",
          "Consejos de Entrevista: Guía completa sobre preguntas comunes y estrategias para la entrevista.",
        ],
      },
      notIncluded: {
        en: [
      ...
      steps: {
        en: [
          "Account Creation: Secure your spot in our digital system.",
          "Payment & Confirmation: Secure payment via credit card or bank transfer.",
          "AI-Powered Onboarding: Quickly provide your details to our intelligent system.",
          "Document Review: Our experts verify every piece of paperwork.",
          "DS-160 Submission: Professional filing of your official application.",
          "Interview Scheduling: Securing your appointment at the embassy/consulate.",
          "Interview Prep & Success: Final coaching before your visa interview.",
        ],
        pt: [
          "Criação de Conta: Garanta sua vaga em nosso sistema digital.",
          "Pagamento e Confirmação: Pagamento seguro via cartão de crédito ou transferência.",
          "Onboarding com IA: Forneça seus detalhes rapidamente ao nosso sistema inteligente.",
          "Revisão de Documentos: Nossos especialistas verificam cada papel.",
          "Submissão do DS-160: Protocolo profissional da sua aplicação oficial.",
          "Agendamento de Entrevista: Garantindo seu horário na embaixada/consulado.",
          "Prep. e Sucesso na Entrevista: Coaching final antes da sua entrevista de visto.",
        ],
        es: [
          "Creación de Cuenta: Asegure su lugar en nuestro sistema digital.",
          "Pago y Confirmación: Pago seguro con tarjeta de crédito o transferencia.",
          "Onboarding con IA: Proporcione sus detalles rápidamente a nuestro sistema inteligente.",
          "Revisión de Documentos: Nuestros expertos verifican cada documento.",
          "Envío del DS-160: Presentación profesional de su solicitud oficial.",
          "Programación de Entrevista: Asegurando su cita en la embajada/consulado.",
          "Prep. y Éxito en la Entrevista: Coaching final antes de su entrevista de visa.",
        ],
      },
      faq: [
        {
          q: {
            ...
            pt: "Quanto tempo leva o processo?",
            es: "¿Cuánto tiempo dura el proceso?",
          },
          a: {
            en: "The timeline varies by consulate, but we typically complete our part of the preparation within 5-7 business days. We recommend starting at least 3 months before your program start date.",
            pt: "O cronograma varia conforme o consulado, mas geralmente concluímos nossa parte da preparação em 5 a 7 dias úteis. Recomendamos começar pelo menos 3 meses antes da data de início do seu programa.",
            es: "El cronograma varía según el consulado, pero generalmente completamos nuestra parte de la preparación en 5-7 días hábiles. Recomendamos comenzar al menos 3 meses antes de la fecha de inicio de su programa.",
          },
        },
        {
          q: {
            en: "What if my visa is denied?",
            pt: "E se o meu visto for negado?",
            es: "¿Qué pasa si mi visa es negada?",
          },
          a: {
            en: "While we have a high success rate, visa decisions are ultimately up to the consular officer. We provide a post-denial analysis and guidance for re-application if necessary.",
            pt: "Embora tenhamos uma alta taxa de sucesso, as decisões sobre o visto cabem, em última análise, ao oficial consular. Oferecemos análise pós-negativa e orientação para nova aplicação, se necessário.",
            es: "Si bien tenemos una alta tasa de éxito, las decisiones sobre la visa dependen en última instancia del oficial consular. Brindamos un análisis posterior a la denegación y orientación para una nueva solicitud si es necesario.",
          },
        },
        {
          q: {
            en: "Are embassy fees included?",
            pt: "As taxas da embaixada estão incluídas?",
            es: "¿Están incluidas las tasas de la embajada?",
          },
          a: {
            en: "No, the US$ 350.00 is for our consulting service. You will still need to pay the DS-160 fee (MRV fee) and SEVIS fee directly to the US government agencies.",
            pt: "Não, os US$ 350,00 referem-se ao nosso serviço de consultoria. Você ainda precisará pagar a taxa do DS-160 (taxa MRV) e a taxa SEVIS diretamente aos órgãos governamentais dos EUA.",
            es: "No, los US$ 350,00 corresponden a nuestro servicio de consultoría. Aún deberá pagar la tarifa del DS-160 (tarifa MRV) y la tarifa SEVIS directamente a las agencias gubernamentales de los EE. UU.",
          },
        },
      ],
    },
    {
      ...
      originalPrice: { en: "US$ 400.00", pt: "US$ 400,00", es: "US$ 400,00" },
      description: {
        en: "Guide to request status extension with USCIS using Form I-539. Ideal for those in the US with a valid visa needing more time before returning. This platform simplifies the complex paperwork through intuitive steps and AI-driven document organization.",
        pt: "Guia para solicitar extensão de status junto ao USCIS usando o formulário I-539. Ideal para quem está nos EUA com visto válido e precisa de mais tempo antes de retornar. Esta plataforma simplifica a papelada complexa através de etapas intuitivas e organização de documentos orientada por IA.",
        es: "Guía para solicitar extensión de estatus ante USCIS usando el formulario I-539. Ideal para quienes están en EE.UU. con visa válida y necesitan más tiempo antes de regresar. Esta plataforma simplifica el papeleo complejo a través de pasos intuitivos y organización de documentos impulsada por IA.",
      },
      forWhom: {
        en: [
      ...
      included: {
        en: [
          "Step-by-step I-539 guide",
          "Extension document checklist",
          "Filling guidance",
          "Bonus: AI Data Organization",
          "Final Package (PDF)",
          "USCIS Deadlines",
        ],
        pt: [
          "Guia passo a passo do I-539",
          "Checklist de documentos de extensão",
          "Orientação de preenchimento",
          "Bônus: Organização de dados por IA",
          "Pacote Final (PDF)",
          "Prazos do USCIS",
        ],
        es: [
          "Guía paso a paso del I-539",
          "Checklist de documentos de extensión",
          "Guía de llenado",
          "Bonus: Organización de datos por IA",
          "Paquete Final (PDF)",
          "Plazos de USCIS",
        ],
      },
