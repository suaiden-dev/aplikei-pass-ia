...
cross join (values
  ...
  (6,  'Carta de Suporte',             'Responda às perguntas para elaboração da sua carta de suporte.',                         'form',         true,  '{"form_id":"cover_letter"}'::jsonb),
  ...
  (12, 'Pacote Final',                 'Seu pacote completo está pronto. Revise e confirme o envio ao USCIS.',                    'info',         true,  '{}'::jsonb)
) as s("order", title, description, type, is_required, config)
