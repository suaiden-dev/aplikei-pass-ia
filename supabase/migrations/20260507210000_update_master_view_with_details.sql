-- Update v_master_office_stats to include more office details
-- Dropping first because Postgres doesn't allow changing column order with CREATE OR REPLACE
DROP VIEW IF EXISTS public.v_master_office_stats;

create view public.v_master_office_stats as
